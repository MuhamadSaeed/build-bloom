            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <TextEffect
                  ...
                  speedSegment={0.3}
                  as="h1"
                  className="mt-8 text-balance text-5xl font-semibold md:text-7xl lg:mt-16 xl:text-[5.25rem]"
                >
                  We Build. You Bloom.
                </TextEffect>
                ...
                >
                  Custom software and digital products built to solve real
                  business problems and move your business forward.
                </TextEffect>
